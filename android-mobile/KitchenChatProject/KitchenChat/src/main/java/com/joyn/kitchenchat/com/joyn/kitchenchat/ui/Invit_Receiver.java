...
import com.orange.labs.hackizard.R;
import com.orange.labs.hackizard.network.Utils;
 ...
 * Receive chat
 */
public class Invit_Receiver extends Activity implements ClientApiListener, ImsEventListener  {
	/**
     * UI handler
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoAccept = getIntent().getBooleanExtra("autoAccept", true);

		// Remove the notification
		Invit_Receiver.removeChatNotification(this, sessionId);
    ...
    public void handleApiDisabled() {
		handler.post(new Runnable() { 
			public void run() {
				Utils.showMessageAndExit(Invit_Receiver.this, getString(R.string.label_api_disabled));
			}
		});
    }
    ...
    public void handleApiConnected() {
		try{
			...
			if (chatSession == null) {
				...
				Utils.showMessageAndExit(Invit_Receiver.this, getString(R.string.label_session_has_expired));
				return;
			}
          ...
          /*  if (autoAccept) {*/
            	...
            	try {
        			...
        			handler.post(new Runnable() { 
        				public void run() {
        					Utils.showMessageAndExit(Invit_Receiver.this, getString(R.string.label_invitation_failed));
        				}
        			});
            	}
           ...
           /* } else {
			...
			handler.post(new Runnable(){
				public void run(){
					Utils.showMessageAndExit(Invit_Receiver.this, getString(R.string.label_api_failed));
				}
			});
		}
    }
    ...
    public void handleApiDisconnected() {
		handler.post(new Runnable(){
			public void run(){
				Utils.showMessageAndExit(Invit_Receiver.this, getString(R.string.label_api_disconnected));
			}
		});
    }
	...
	public void handleImsDisconnected(int reason) {
		...
		handler.post(new Runnable(){
			public void run(){
				Utils.showMessageAndExit(Invit_Receiver.this, getString(R.string.label_ims_disconnected));
			}
		});
	}    
	...
	private IChatEventListener chatSessionListener = new IChatEventListener.Stub() {
		...
		public void handleSessionStarted() {
			try {
				...
				if (chatSession.isGroupChat()) {
		        	/*intent = new Intent(Invit_Receiver.this, GroupChatView.class);
		        	intent.putExtra("subject", subject);*/
				} else {
		        	intent = new Intent(Invit_Receiver.this, ChatView.class);
		...
		public void handleSessionAborted(int reason) {
			handler.post(new Runnable(){
				public void run(){
					Utils.showMessageAndExit(Invit_Receiver.this, getString(R.string.label_invitation_declined));
				}
			});
		}
		...
		public void handleSessionTerminatedByRemote() {
			handler.post(new Runnable(){
				public void run(){
					Utils.showMessageAndExit(Invit_Receiver.this, getString(R.string.label_chat_terminated_by_remote));
				}
			});
		}
    ...
    public static void addChatInvitationNotification(Context context, Intent invitation) {
		...
		intent.setClass(context, Invit_Receiver.class);
